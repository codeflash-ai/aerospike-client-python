...
def list_trim(bin_name: str, index, count, ctx: Optional[list] = None):
    ...
    if ctx:
        return {OP_KEY: aerospike.OP_LIST_TRIM, BIN_KEY: bin_name, INDEX_KEY: index, VALUE_KEY: count, CTX_KEY: ctx}
    return {OP_KEY: aerospike.OP_LIST_TRIM, BIN_KEY: bin_name, INDEX_KEY: index, VALUE_KEY: count}
